      ...
      <div class="form-container">
        <form @submit.prevent="submitForm" class="card-form">
          <div class="form-group">
            ...
            <span v-if="cardNumber.value && !isCardNumberValid" class="error">Número de tarjeta no válido</span>
          </div>
          ...
          <div class="form-group">
            ...
            <span v-if="expiry.value && !isExpiryValid" class="error">Fecha de vencimiento no válida</span>
          </div>

          <div class="form-group">
            <label for="cvv">Código de seguridad</label>
            <input type="text" id="cvv" v-model="cvv" maxlength="3" placeholder="Ingresar..." />
            <span v-if="cvv.value && !isCVVValid" class="error">CVV no válido</span>
          </div>
