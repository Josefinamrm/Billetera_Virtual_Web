      ...
      <div class="popup-content">
        ...
        <div class="popup-options">
          <div class="popup-option">
            ...
            <input v-model="paymentLinkAmount" type="number" placeholder="Monto a pagar" class="popup-input">
          ...
          <div class="popup-option">
            ...
            <input v-model="depositAmount" type="number" placeholder="Cantidad a ingresar" class="popup-input">
